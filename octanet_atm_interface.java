...
class alltimemoney {
    ...
    public void displayMenu() {
        ...
        System.out.println("4. Press 4 to transfer the amount");
        ...
        while (true) {
            ...
            switch (choice) {
                ...
                case 3:
                    ...
                    break;
                case 4: 
                    System.out.println("Enter the person name to whom you want to transfer the amount");
                    scanner.nextLine();
                    String  name  = scanner.nextLine();
                    System.out.println("Enter the account number");
                    int a = scanner.nextInt();
                    System.out.println("Enter the transfer amount: Rs. ");
                    amount = scanner.nextDouble();
